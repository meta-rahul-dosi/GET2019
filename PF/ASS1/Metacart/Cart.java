...
public class Cart
{
   	 ...
   	 static String[] checkItem = new String[5];
   	 static int j=0;
   	 static float price, qty; 
   	 static HashMap<String, Float> myCart = new HashMap<String, Float>();
   	 static HashMap<String, Integer> amount = new HashMap<String, Integer>();
   	 ...
   	 public static void main(String args[]) 
	{
     ...
     static void addItem(String s, float p)
     {
       ...
       for(int i=0; i<checkItem.length; i++)
       {
    	if(s==checkItem[i])
    	{
         float previousQty = myCart.get(s);		
         myCart.put(s,p+previousQty);
         l=1;
    	}
     }
       ...
       System.out.println(Collections.singletonList(myCart));
     }
