...
public class EmployeeList {
	...
	/**
	 * this method generate partition of employee and generates reference to the
	 * pivot node
	 * 
	 * @param low
	 * @param high
	...
	public EmployeeNode partition(EmployeeNode low, EmployeeNode high) {
		...
		for (EmployeeNode iterator2 = low; iterator2 != high; iterator2 = iterator2.next) {
			if (iterator2.getEmployee().getSalary() >= pivotSalary) {
				...
				iterator1.getEmployee().salary = iterator2.getEmployee()
						.getSalary();
				iterator1.getEmployee().dob = iterator2.getEmployee().getdob();
				iterator1.getEmployee().empId = iterator2.getEmployee()
						.getEmpId();
				iterator1.getEmployee().name = iterator2.getEmployee()
						.getName();
